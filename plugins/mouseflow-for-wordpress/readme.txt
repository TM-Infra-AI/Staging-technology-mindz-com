...
Tags: mouseflow, analytics, heatmaps, user behaviour, ux, user experience, session recording 
Requires at least: 4.5.0
Tested up to: 6.3
Stable tag: 5.1.3

Mouseflow gives you free and easy-to-use conversion and user experience analytics for your website. Analyze conversion funnels, heatmaps and even session recordings directly from your Wordpress dashboard.

== Description ==

With Mouseflow for Wordpress you can access everything Mouseflow has to offer - directly from your Wordpress dashboard! Learn more about your visitors by analyzing heatmaps and recordings of user sessions, including mouse movements, clicks, scroll events and more. The plugin makes it quick and easy to install Mouseflow on your Wordpress-site.
...
You get the tracking code by signing up on Mouseflow.com. You can easily create an account for free by following this link: https://app.mouseflow.com/sign-up
...
4. Read more here: https://help.mouseflow.com/en/articles/4278980-recording-status-is-not-installed
5. Get in touch: https://help.mouseflow.com/