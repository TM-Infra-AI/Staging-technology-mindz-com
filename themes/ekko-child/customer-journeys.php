<?php
/*
Template Name: Customer Journeys
*/
?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/cross-channel-marketing-1.png" alt="">
                    </div>
                    <div style="left: 53%;top: -628px;" class="callout-module callout">
                        <div class="content">
                            <h3 class="headline">1. Leverage One Cross-Channel Marketing Platform</h3>
                            <p class="copy">Marketing Cloud is a platform for managing customer journeys across email, mobile, social, ads, websites, and connected devices. See how it can help you deliver the right message, at the right time, on the right channel.</p>
        ...
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12" style="position: relative;">
                    <div class="item-pagination">
                     <img src="https://technologymindz.com/wp-content/uploads/2025/05/cross-channel-marketing-2.png" alt="">
                    </div>
                    <div style="left: 70%;top: -580px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">2. Plan, Personalize, and Optimize Journeys</h3>
                            <p class="copy">Journey Builder manages 1-to-1 interactions across channels. You can design customer journeys, listen for customer activity, and automatically respond with customized communications.</p>
                            <button slide="2" class="secondpagebtn">Next</button>                           
                        </div>                        
                    </div>
                    
                        <!-- CTA Tooltip that slides in and out -->
                        <div class="cta-tooltip-new cta-tooltip-hidden" style="width: 280px;bottom: 29%;left: 70%;z-index: 99;">
    ...
    <section class="tab-pagination-section tab-pagination-section3">
       <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/cross-channel-marketing-3.png" alt="">
                    </div>
                    <div style="left: 69%;top: -500px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">3. Map the Journey Across the Lifecycle</h3>
                            <p class="copy">Journey Builder has the tools to create interactive customer journeys. Illustrate how customers will experience your brand across channels — reaching them no matter where they are in the customer lifecycle.</p>
    ...
    <section class="tab-pagination-section tab-pagination-section4">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/cross-channel-marketing-4.png" alt="">
                    </div>
                    <div style="left: 32%;top: -580px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">4. Customize Your Story</h3>
                            <p class="copy">It’s easy to bring your journeys to life. Add all approved brand assets such as images and notes with drag-and-drop tools.</p>
    ...
    <section class="tab-pagination-section tab-pagination-section5">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/cross-channel-marketing-5.png" alt="">
                    </div>
                    <div style="left: 34%;top: -520px;" class="callout-module left callout">
                        <div class="content">
                            <h3 class="headline">5. Bring the Journey to Life</h3>
                            <p class="copy">The visual journey mapping feature is an interactive canvas. Drill down to view interactions based on customer activity.</p>
