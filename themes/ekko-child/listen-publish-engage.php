<?php
/*
Template Name: Listen Publish Engage
*/
?>
...
<head>
    ...
    <title>Listen Publish Engage</title>
...
.tab-pagination-section1 .callout-module.righttop:before{
    top: 22%;
    right: -55px;
    border-left: 30px solid #c5b7be;
}
...
.tab-pagination-section8 .callout-module.righttop:before{
    top: 8%;
    right: -55px;
    border-left: 30px solid #c5b7be;
}
...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12" id="pageHeading">
                    <div class="paginationheading">
                        <h2>PLAN CROSS-CHANNEL CUSTOMER JOURNEYS</h2>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-tools-1.png" alt="">
                    </div>
                    <div style="left: 7%;top: -624px;" class="callout-module righttop callout">
                        <div class="content">
                            <h3 class="headline">1. Leverage One Cross-Channel Marketing Platform</h3>
                            <p class="copy">Social Studio provides everything marketers need to cultivate more meaningful social relationships. Explore ways to manage your social strategy, and engage with customers and prospects in a whole new way.</p>
    ...
    <section class="tab-pagination-section tab-pagination-section2">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                     <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-tools-3.png" alt="">
                    </div>
                    <div style="left: 71%;top: -610px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">2. Tailor Your Strategy to Your Company</h3>
                            <p class="copy">Workspaces help you stay organized by aligning to your team’s structure. Manage your strategy by team, brand, or geography with a flexible framework. Each workspace can be assigned users, permission hierarchies, and social accounts.</p>
       ...
       <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12" style="position: relative;">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-tools-4.png" alt="">
                    </div>
                    <div style="left: 74%;top: -600px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">3. Listen to What the Social World Has to Say</h3>
                            <p class="copy">Tap into what customers are saying about your brand, products, and competitors on channels like social networks, blogs, forums, and online news. You can define topics of interest, see where conversations are happening, and understand sentiment.</p>
                            <button slide="3" class="thirdpagebtn">Next</button>                            
                        </div>                        
                    </div>

                     <!-- CTA Tooltip that slides in and out -->
                     <div class="cta-tooltip-new cta-tooltip-hidden" style="width: 280px;bottom: 29%;left: 74%;z-index: 99;">
    ...
    <section class="tab-pagination-section tab-pagination-section4">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-tools-5.png" alt="">
                    </div>
                    <div style="left: 74%;top: -600px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">4. Analyze the Conversation</h3>
                            <p class="copy">You can access metrics like sentiment, post volumes, regional data, languages, and the 50 most-mentioned terms around any subject. Understand what topics are trending, then use the data to drive your marketing strategy and content.</p>
    ...
    <section class="tab-pagination-section tab-pagination-section5">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-tools-6.png" alt="">
                    </div>
                    <div style="left: 75%;top: -550px;" class="callout-module left callout">
                        <div class="content">
                            <h3 class="headline">5. Consolidate Your Content Calendar</h3>
                            <p class="copy">A shared collaboration calendar makes it simple to create content and see what is scheduled to be published on channels like Facebook, Twitter, Instagram, Pinterest, YouTube, and LinkedIn.</p>
                            <button slide="5">Next</button>                            
                        </div>                        
                    </div>
                </div>
            </div>
    ...
    <section class="tab-pagination-section tab-pagination-section6">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-tools-8.png" alt="">
                    </div>
                    <div style="left: 75%;top: -550px;" class="callout-module left callout">
                        <div class="content">
                            <h3 class="headline">6. Protect Your Brand with Approval Rules</h3>
                            <p class="copy">Publish relevant content in a timely fashion with folders for pre-approved content. Avoid lengthy approval processes with a full audit trail — so any team member can post efficiently.</p>
                            <button slide="6">Next</button>                           
                        </div>                        
                    </div>
                </div>
            </div>
    ...
    <section class="tab-pagination-section tab-pagination-section7">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-automation-2.png" alt="">
                    </div>
                    <div style="left: 72%;top: -550px;" class="callout-module left callout">
                        <div class="content">
                            <h3 class="headline">7. Detect and Respond to Service Issues</h3>
                            <p class="copy">When service-related concerns are identified, they can be labeled, classified, and assigned to a member of your team, or a service agent. You can resolve customer concerns directly from the interactive dashboard.</p>
                            <button slide="7">Next</button>                           
                        </div>                        
                    </div>
                </div>
            </div>
    ...
    <section class="tab-pagination-section tab-pagination-section8">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-automation-2-drill1.png" alt="">
                    </div>
                    <div style="left: 45%;top: -560px;" class="callout-module righttop callout">
                        <div class="content">
                            <h3 class="headline">8. Route Concerns to the Right Team</h3>
                            <p class="copy">Resolve simpler cases without escalating them to a customer service team. When a specialist is needed, forward the post with one click to a service agent.</p>
                            <button slide="8">Next</button>                         
                        </div>                        
                    </div>
                </div>
            </div>
    ...
    <section class="tab-pagination-section tab-pagination-section9">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/social-media-automation-5.png" alt="">
                    </div>
                    <div style="left: 58%;top: -590px;" class="callout-module left callout">
                        <div class="content">
                            <h3 class="headline">9. Address Concerns on Social or in Private</h3>
                            <p class="copy">Locate a customer's full history through their Twitter handle in the service console, and respond privately with a direct message or publicly in a post.</p>
