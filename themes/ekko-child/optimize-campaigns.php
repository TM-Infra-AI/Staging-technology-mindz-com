<?php
/*
Template Name: Optimize Campaigns
*/
?>
...
<head>
    ...
    <title>Optimize Campaigns</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/marketing-measurement-1.png" alt="">
                    </div>
                    <div style="left: 43%;top: -510px;" class="callout-module left callout">
                        <div class="content">
                            <h3 class="headline">1. Measure Success Against Specific Business Goals</h3>
                            <p class="copy">Measure much more than clicks and opens. You can define a specific business goal and understand how different factors like frequency, timing, channel, and your message influence conversion.</p>
    ...
    <section class="tab-pagination-section tab-pagination-section2">
        <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="item-pagination">
                     <img src="https://technologymindz.com/wp-content/uploads/2025/05/marketing-measurement-2.png" alt="">
                    </div>
                    <div style="left: 35%;top: -500px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">2. Leverage Data for 1-to-1 Personalization</h3>
                            <p class="copy">Use splits to send different messages based on demographics, individual profiles, and behaviors. You can test messages, channels, and timing.</p>
       ...
       <div class="conteainer-fluid">
            <div class="row">
                <div class="col-md-12" style="position: relative;">
                    <div class="item-pagination">
                        <img src="https://technologymindz.com/wp-content/uploads/2025/05/marketing-measurement-3.png" alt="">
                    </div>
                    <div style="left: 33%;top: -540px;" class="callout-module lefttop callout">
                        <div class="content">
                            <h3 class="headline">3. Activate, Measure, and Adjust</h3>
                            <p class="copy">Monitor the effectiveness of every interaction. Measure goal attribution by time, message, or channel — or simply test-fire combinations of each.</p>
                    ...
                    <div class="cta-tooltip-new cta-tooltip-hidden" style="width: 280px;bottom: 28%;left: 33%;z-index: 99;">
