...
<div id="posts-content" class="blog-single <?php echo esc_attr( $page_layout ); ?>">
	<?php while ( have_posts() ) : the_post(); ?>
		...
		if ( ($single_post_template == 'single-post-layout-two') && ($post_header_image != '' || $banner_image != '') ) : ?>
		    <?php if($banner_image != ''){ ?>
			    <div class="blog-single-header-wrapper <?php echo esc_attr($post_image_class); ?>" style="background-image:url('<?php echo esc_url($banner_image); ?>')">
			  <?php } else {?>
